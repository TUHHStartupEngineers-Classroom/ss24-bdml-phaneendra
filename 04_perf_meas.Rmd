...
library(rsample)
library(recipes)
product_backorders_tbl  <- read_csv("C:/Users/phaneendra s/Desktop/bdml/product_backorders.csv")
...
theme_new <- theme(
  ...
  panel.border     = element_rect(color = "pink", fill = NA, size = 0.5),
  panel.grid.major = element_line(color = "orange", size = 0.333)
) 
...
performance_tbl %>%
  ...
  geom_line(aes(y = recall), color = "yellow", size = 1) +
...
model_metrics_tbl %>%
  ...
  geom_abline(color = "orange", linetype = "dotted") +
...
plot_h2o_performance <- function(h2o_leaderboard, newdata, order_by = c("auc", "logloss"),
  ...
  p3 <- gain_lift_tbl %>%
    ...
    geom_segment(x = 0, y = 0, xend = 1, yend = 1, 
                 color = "pink", size = size, linetype = "dotted") +
    theme_new +
  ...
  p4 <- gain_lift_tbl %>%
    ...
    geom_segment(x = 0, y = 1, xend = 1, yend = 1, 
                 color = "blue", size = size, linetype = "dotted") +
    theme_new +
    expand_limits(x = c(0, 1), y = c(0, 1)) +
    labs(title = "Lift",
