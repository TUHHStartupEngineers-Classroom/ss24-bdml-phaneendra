...
```{r}
# STOCK PRICES
sp_500_prices_tbl <- readRDS("C:/Users/phaneendra s/Desktop/bdml/sp_500_prices_tbl.rds")
sp_500_prices_tbl
```
...
```{r}
# SECTOR INFORMATION
sp_500_index_tbl <- readRDS("C:/Users/phaneendra s/Desktop/bdml/sp_500_index_tbl.rds")
sp_500_index_tbl
```
...
sp_500_daily_returns_tbl <- readRDS("C:/Users/phaneendra s/Desktop/bdml/sp_500_daily_returns_tbl.rds")
sp_500_daily_returns_tbl
```
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
stock_date_matrix_tbl <- readRDS("C:/Users/phaneendra s/Desktop/bdml/stock_date_matrix_tbl.rds")
stock_date_matrix_tbl
```
...
k_means_mapped_tbl %>%
    ...
    ggrepel::geom_label_repel(aes(label = centers), color = "red") + 
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
k_means_mapped_tbl <- readRDS("C:/Users/phaneendra s/Desktop/bdml/k_means_mapped_tbl.rds")
k_means_mapped_tbl
```
...
```{r}
k_means_mapped_tbl <- readRDS("C:/Users/phaneendra s/Desktop/bdml/k_means_mapped_tbl.rds")
umap_results_tbl   <- readRDS("C:/Users/phaneendra s/Desktop/bdml/umap_results_tbl.rds")
umap_results_tbl 
k_means_mapped_tbl 
```
...
umap_kmeans_results_tbl %>%
    ...
    geom_point(alpha=0.5) +
    # Formatting
    scale_color_manual(values= c("pink", "orange", "yellow")) +
